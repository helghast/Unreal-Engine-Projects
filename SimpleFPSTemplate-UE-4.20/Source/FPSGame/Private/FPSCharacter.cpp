...
AFPSCharacter::AFPSCharacter()
{
	...
	// make noise to use ai's noise sense
...
void AFPSCharacter::Tick(float DeltaSeconds)
{
	...
	if (!IsLocallyControlled())
	{
		...
		// since RemoteViewPitch is compressed in 1byte using * 255 / 360, you need to uncompress it
...
{
	// send a RPC to authority server, to replicate to clients the projectile
	ServerFire();
...
void AFPSCharacter::ServerFire_Implementation()
{
	...
	if (ProjectileClass)
	{
		...
		// tell instigator is this, to allow projectiles to know how makes noise
