	...
	DestroyLifeSpan(10.0f)
{
	...
	SpringArmComp = CreateDefaultSubobject<USpringArmComponent>(TEXT("SpringArmCompo"));
...
void ASCharacter::OnHealthChanged(class USHealthComponent* HealthComponent, float Health, float HealthDelta, const class UDamageType* DamageType, class AController* InstigatedBy, class AActor* DamageCauser)
{
...
{
	// dont call super implementation
